...
const APPROACHES = [
  {
    key: 'A', title: '🅰 합성 (모션그래픽) — 추천', cost: '0원',
    pros: ['깔끔·예측 가능 (스티커 효과의 정석)', '인물/빈백/고양이 형태 안 뭉개짐', '촤악 SFX·새 배경 정밀 싱크', '크레딧 0'],
    cons: ['컷아웃 품질에 의존 (경계 다듬기 필요)', 'AI 특유의 "살아있는" 질감은 덜함'],
    how: '인물(+빈백+고양이) 배경 분리 컷아웃 → peel/기울임 애니메이션 + 새 배경에 탁 붙는 모션 → 촤악 SFX 후반 싱크 (ffmpeg/PIL/remotion, 로컬)',
  },
  {
...
const QUESTIONS = [
  ['뜯어낼 대상 범위', '인물+빈백+고양이 통째? / 인물만? / 인물+빈백?'],
  ['붙일 새 배경', '어떤 배경에 붙일지 (URL로 제공) — "붙이기" 완성에 필수'],
  ['방식 선택', '🅰 합성(추천) vs 🅑 Seedance 실험'],
