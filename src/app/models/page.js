    ...
    models: [
      {
        ...
        ref: `${FTP}/B_A_rep.jpg?v=e2`,
        sheets: { face: `${FTP}/B_A_face.png?v=hairB`, expr: `${FTP}/B_A_expr.png?v=v1`, body: `${FTP}/B_A_body.png?v=v1`, pose: `${FTP}/B_A_pose.png?v=v2` },
      ...
      },
      {
        ...
        sheets: { face: `${FTP}/B_C_face.png?v=hairC`, expr: `${FTP}/B_C_expr.png?v=v1`, body: `${FTP}/B_C_body.png?v=v1`, pose: `${FTP}/B_C_pose.png?v=v3` },
        soulId: null, status: '얼굴 시트 ✅ · 표정/바디/포즈 대기',
      },
      {
    ...
    models: [
      {
        ...
        sheets: { face: `${FTP}/M_A_face.png?v=hairMA`, expr: `${FTP}/M_A_expr.png?v=v1`, body: `${FTP}/M_A_body.png?v=v1`, pose: `${FTP}/M_A_pose.png?v=v2` },
