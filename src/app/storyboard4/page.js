...
const REF_CUTS = [
  ...
  { n: 9, t: '11.3–12.1s', dur: '1.6s', ref: '/ref_family/cut09.jpg', refVid: V('c09_ref'), angle: '식탁 높이 사이드 CU', ours: '이유식 컷 (원본 충실) — 엄마가 숟가락으로 먹여줌 + 미소 여운, 크림 맨투맨 연속성', mine: '/ref_family/cut09_ours.png?v=2', vid: V('c09_ours', 2) },
  { n: 10, t: '12.1–13.0s', dur: '1.5s', ref: '/ref_family/cut10.jpg', refVid: V('c10_ref'), angle: '하이키 클로즈업 · 가족 셋', ours: '가족 완성 — 아빠(머스터드 니트) 재등장, 전경 손장난 → 아기가 손가락 잡는 순간까지', mine: '/ref_family/cut10_ours.png?v=1', vid: V('c10_ours', 2) },
  { n: 11, t: '13.0–15.0s', dur: '3.0s', ref: '/ref_family/cut11.jpg', refVid: V('c11_ref'), angle: '인티밋 클로즈업 · 엔딩', ours: '부인이 아쿠아 Max에 뺨 기대고 아기를 내려다봄 — 라운징 엔딩 + 로고 중앙 페이드인(원본 동일 크기·위치)', mine: '/ref_family/cut11_ours.png?v=1', vid: V('c11_ours', 2) },
];
