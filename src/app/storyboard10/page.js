...
const CAST = [
  { role: '아이 (주연) — 딸', el: '신규 캐스팅 게이트', img: '/fam2/c4_winter_v3.png?v=1', imgNote: '성장 출발점 = 2탄 C4 돌쟁이(최신 승인 룩)', note: '2~3살 여아 (2026-07-10 사용자 확정: 딸) — 2탄 아기(ef781c67)의 성장형. 성장 편집 = 드리프트 최고위험 → 처음부터 3중 락(2탄 C4 승인컷 얼굴참조 + Element + 프로즈). 첫 스틸에서 룩 확정 후 신규 Element 락 검토' },
