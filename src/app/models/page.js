...
const CATEGORIES = [
  ...
  },
  {
    ...
    models: [
      {
        code: 'A', name: '유럽계 여아 · 라이트브라운 양갈래 땋은머리 · 밝음',
        size: '키 약 120cm · 유아~저학년 (아동 비례)',
        identity: '유럽계 여아 6~7세 · 라이트브라운 양갈래 땋은 머리(센터파트·헤어핀) · 둥근 볼 · 밝고 명랑 · 자연 피부',
        ref: `${FTP}/K_A_rep.jpg?v=40`,
        sheets: { face: `${FTP}/K_A_face.png?v=braid`, expr: `${FTP}/K_A_expr.png?v=braid`, body: `${FTP}/K_A_body.png?v=v1`, pose: `${FTP}/K_A_pose.png?v=v4` },
        soulId: null, status: '①얼굴 ②표정 헤어변경 완료(양갈래·라이트브라운) ✅ · ③바디 ④포즈는 구헤어 → 재생성 필요',
      },
      {
        code: 'B', name: '유럽계 여아 · 레디시브라운 롱 생머리(센터파트) · 청순(주근깨)',
        size: '키 약 150cm · 초등 고학년/틴 (아동 비례)',
        identity: '유럽계 여아 10~12세 · 레디시브라운 롱 스트레이트(센터파트) · 옅은 주근깨 · 따뜻한 미소 · 자연 피부',
        ref: `${FTP}/K_B_rep.jpg?v=40`,
        sheets: { face: `${FTP}/K_B_face.png?v=straight`, expr: `${FTP}/K_B_expr.png?v=straight`, body: `${FTP}/K_B_body.png?v=v1`, pose: `${FTP}/K_B_pose.png?v=v1` },
        ...
        soulId: null, status: '①얼굴 ②표정 헤어변경 완료(롱 생머리·센터파트, 컬러유지) ✅ · ③바디 ④포즈는 구헤어 → 재생성 필요',
      },
    ],
  },
];
