    ...
    models: [
      {
        ...
        ref: `${FTP}/B_A_rep.jpg?v=hair`,
        sheets: { face: `${FTP}/B_A_face.png?v=hairB2`, expr: `${FTP}/B_A_expr.png?v=hair`, body: `${FTP}/B_A_body.png?v=v1`, pose: `${FTP}/B_A_pose.png?v=v2` },
      ...
      },
      {
        ...
        ref: `${FTP}/B_C_rep.jpg?v=hair`,
        sheets: { face: `${FTP}/B_C_face.png?v=hairC2`, expr: `${FTP}/B_C_expr.png?v=hair`, body: `${FTP}/B_C_body.png?v=v1`, pose: `${FTP}/B_C_pose.png?v=v3` },
        soulId: null, status: '얼굴 시트 ✅ · 표정/바디/포즈 대기',
      },
      {
        ...
        ref: `${FTP}/B_D_rep.jpg?v=hair`,
        sheets: { face: `${FTP}/B_D_face.png?v=hairD3`, expr: `${FTP}/B_D_expr.png?v=hair`, body: `${FTP}/B_D_body.png?v=v1`, pose: `${FTP}/B_D_pose.png?v=v3` },
        soulId: null, status: '얼굴 시트 ✅ · 표정/바디/포즈 대기',
      },
    ],
  },
    ...
    models: [
      {
        ...
        ref: `${FTP}/M_A_rep.jpg?v=hair`,
        sheets: { face: `${FTP}/M_A_face.png?v=hairMA2`, expr: `${FTP}/M_A_expr.png?v=hair`, body: `${FTP}/M_A_body.png?v=v1`, pose: `${FTP}/M_A_pose.png?v=v2` },
