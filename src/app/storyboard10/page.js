...
const CUTS = [
  ...
  },
  {
    ...
    img: '/fam3/c5_sleep_v3.png?v=1',
    status: '🟡 스틸 v3 (6cr: v1 3인→v2 엄마 단독 전환(아빠 드리프트 반복으로 사용자 결정)→v3 담요 물리 교정) — 엄마가 딸 위로 담요를 펼쳐 덮는 중, wife-c3 완벽 재현 · 티렉스 품 · 맥스 수미상관. 확정 대기 → 영상화 5.25cr (담요 내려앉음 = C4 낙하 모션 매치)',
  },
];
