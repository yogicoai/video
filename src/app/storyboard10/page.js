...
const CUTS = [
  ...
  },
  {
    ...
    title: '셋이 나란히 — 요기보 더블 엔딩 (시리즈 수미상관)',
    motion: '셋이 더블에 나란히 파묻혀 숨 고르기, 아이가 부모 사이에서 까르르 · 미세 호흡·웃음만',
    desc: '와이드 — 엄마·아이·아빠가 요기보 더블(라이트그레이 · 레지스트리 f2553ed0 · 2인용+ 대형)에 나란히 파묻혀 쉬는 엔딩 (2026-07-10 사용자 확정: 더블은 마지막 구도 전용). 각자 놀던 가족이 하나의 더블에 모이는 제품 스토리텔링 + 1탄 엔딩(부부+신생아)과 수미상관. 맥스는 셋이 눕기엔 1인용이라 실측상 더블이 정답. 더블 Element 락(360, 무료) 선행.',
