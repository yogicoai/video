...
const CUTS = [
  ...
  },
  {
    ...
    title: '셋이 나란히 + 로고 — 더블 엔딩 (시리즈 수미상관)',
    motion: '셋이 더블에 파묻혀 숨 고르기·까르르 → 마지막 1초에 로고가 화면에 박히며 끝',
    desc: '와이드 — 엄마·아이·아빠가 요기보 더블(라이트그레이 · f2553ed0 · 2인용+ 대형)에 나란히 파묻혀 쉬고, 영상 끝에 요기보 로고가 정중앙 페이드인되며 마무리 (2026-07-10 확정: 별도 엔딩카드 C6 삭제 — 1탄 엔딩 문법과 동일). 각자 놀던 가족이 하나의 더블에 모이는 제품 스토리텔링 + 수미상관. 더블 Element 락(360, 무료) 선행. 티렉스 메이트 = 딸 품에(단짝 릴레이 마무리).',
    status: '⬜ 대기 — 더블 Element 락 후 스틸 (C3 톤 기준)',
  },
];
