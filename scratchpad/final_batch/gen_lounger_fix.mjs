...
const G2 = [
  { id: 'C_pastelblue', model: 'C', color: 'pastelblue', outfit: 'C_W_C_01', cuts: [
    { id: 'lg_c_pastelblue_p5', pose: 5, file: 'cand_lounger_pastelblue_c_p5', scaleExtra: 'NOTE: an earlier attempt rendered the bag far too small (pouf-like) - the curled-up woman must fit entirely inside the seat with room to spare on both sides and the backrest rising to her shoulder blades.' },
    { id: 'lg_c_pastelblue_p2', pose: 2, file: 'cand_lounger_pastelblue_c_p2' },
    { id: 'lg_c_pastelblue_p4', pose: 4, file: 'cand_lounger_pastelblue_c_p4' } ] },
  { id: 'B_freshmint', model: 'B', color: 'freshmint', outfit: 'B_W_C_01', cuts: [
    { id: 'lg_b_freshmint_p4', pose: 4, file: 'cand_lounger_freshmint_b_p4' },
    { id: 'lg_b_freshmint_p5', pose: 5, file: 'cand_lounger_freshmint_b_p5' },
    { id: 'lg_b_freshmint_p1', pose: 1, file: 'cand_lounger_freshmint_b_p1' } ] },
  { id: 'MA_navy', model: 'MA', color: 'navy', outfit: 'A_M_C_02', cuts: [
    { id: 'lg_ma_navy_p5', pose: 5, file: 'cand_lounger_navy_ma_p5' },
    { id: 'lg_ma_navy_p2', pose: 2, file: 'cand_lounger_navy_ma_p2' },
    { id: 'lg_ma_navy_p1', pose: 1, file: 'cand_lounger_navy_ma_p1' } ] },
  { id: 'KA_olive', model: 'KA', color: 'olive', outfit: 'KID_A_01', cuts: [
    { id: 'lg_ka_olive_p3', pose: 3, file: 'cand_lounger_olive_ka_p3' },
    { id: 'lg_ka_olive_p4', pose: 4, file: 'cand_lounger_olive_ka_p4' },
    { id: 'lg_ka_olive_p7', pose: 7, file: 'cand_lounger_olive_ka_p7' } ] },
]
const outList = []
